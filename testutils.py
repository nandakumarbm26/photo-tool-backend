...
def getEyeQImage():
    t=subprocess.check_output('curl -H "X-API-KEY: 3584ff8a41351bdddafd96c7105d3f4f85f" -H "Content-Type: image/jpeg" -X PUT "https://api.perfectlyclear.io/v1/pfc" --upload-file input.jpg',shell=True,text=True)
    t=json.loads(t)
